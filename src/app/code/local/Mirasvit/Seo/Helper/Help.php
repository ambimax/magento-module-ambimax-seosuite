...
class Mirasvit_Seo_Helper_Help extends Mirasvit_MstCore_Helper_Help
{
    protected $_help = array(
        'system' => array(
            ...
            'extended_remove_keywords_meta_tag'                      => 'Remove <i>meta name="keywords"</i> tag and it\'s content from HEAD section of store pages',
            ...
            'snippets_logo_organization_snippets'                    => 'If set to "Add Logo from Store Information" logo will be added from System->General->Design->Header->Logo Image Src. If set "Add Logo manually" you can provide full URL for needed image.',
            'snippets_manual_logo_organization_snippets'             => 'Define full logo URL manually.<xmp></xmp>Example:
                                                                        http://example.com/skin/images/media/customlogo.png',
            'snippets_same_as_organization_snippets'                 => 'Define links to social profiles of your organization.<xmp></xmp>Example:
                                                                        http://www.facebook.com/your-profile
                                                                        http://instagram.com/yourProfile
                                                                        http://www.linkedin.com/in/yourprofile
                                                                        http://plus.google.com/your_profile',
            'snippets_is_opengraph'                                  => 'Adds Facebook Opengraph tags to the head of each product\'s page.',
            'snippets_is_twitter_card'                               => 'Adds Twitter Card tags to the head of each product\'s page.',
            'snippets_twitter_username'                              => 'The Twitter @username the card should be attributed to. Required for Twitter Card analytics',
            ...
            'url_layered_navigation_friendly_urls_separator'         => 'Allows to choose separator symbol for URLs of complex filter names in Layered Navigation.
                                                                        <xmp></xmp>Examples:
                                                                        <xmp></xmp>site.com/vip/black-decorativeaccents.html
                                                                        <xmp></xmp>site.com/vip/black-decorative_accents.html',
