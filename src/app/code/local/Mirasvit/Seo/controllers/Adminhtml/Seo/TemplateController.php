...
class Mirasvit_Seo_Adminhtml_Seo_TemplateController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction ()
    {
        if ($data = $this->getRequest()->getPost()) {
            ...
            // to avoid frontend "id already exists" exception for some stores
            $data['store_ids'] = isset($data['store_ids']) ? array_unique($data['store_ids']) : array(); 
            ...
            try {
                ...
                if ($model->getIsActive() && $templateName = $model->getName()) {
                    switch ($templateName) {
                        case 'Example Product SEO Template':
                            Mage::getSingleton('adminhtml/session')->addNotice('Example Product SEO Template has been enabled.'
                                .' You may check meta data applied to product pages of your store.');
                            break;
                        case 'Example Category SEO Template':
                            Mage::getSingleton('adminhtml/session')->addNotice('Example Category SEO Template has been enabled.'
                                .' You may check meta data applied to category pages of your store');
                            break;
                        case 'Example Layered Navigation SEO Template':
                            Mage::getSingleton('adminhtml/session')->addNotice('Example Layered Navigation SEO Template has been enabled.'
                                .' You may check meta data applied to filtered category pages of your store.');
                            break;
                    }
                }
