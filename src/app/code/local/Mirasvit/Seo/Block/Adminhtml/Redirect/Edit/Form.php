...
class Mirasvit_Seo_Block_Adminhtml_Redirect_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('url_from', 'text', array(
            ...
            'note'      => '<b>Redirect from this URL.</b> E.g. <i>/some/old/page.html</i><br/>
                            Wildcards can be used. For example: </br>
                            <i>/some/old/category/*</i> </br>
                            <i>*/old/category/product.html</i> </br>
                            <i>*some/old/category*</i>
                            ',
        ));
        ...
        $fieldset->addField('url_to', 'text', array(
            ...
            'note'      => '<b>Redirect to this URL.</b> Can be given as a URL path: </br>
                            <i>/some/new/page.html</i> </br>
                            or as a full URL:
                            <i>http://your.site.com/some/new/page.html</i> </br>
                            External URL can be defined only as full URL: </br>
        ...
        $fieldset->addField('sort_order', 'text', array(
            ...
            'note'      => 'Rules with higher priority are applied first',
        ));
