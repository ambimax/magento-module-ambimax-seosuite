...
class Mirasvit_SeoAutolink_Model_Config
{
    ...
    public function getSkipRecursive()
    {
        return Mage::getStoreConfig('seoautolink/autolink/skip_recursive');
    }

    public function isEnabledLanguageWithoutSpaceCompatibility($store = null)
    {
        return Mage::getStoreConfig('seoautolink/autolink/language_without_space_compatibility', $store);
    }
}
