...
class Mirasvit_SeoSitemap_Model_ImageAdapter extends Varien_Image_Adapter_Gd2 {

    /**
     * Destroy object image on shutdown
     * This function is not present in Magento < 1.9.0.2
     *
     * @return void
     */
...
class Mirasvit_SeoSitemap_Model_ImageVarien extends Varien_Image {

    /**
     * @param null $fileName
     * @param string|Varien_Image_Adapter $adapter
     * @throws Exception
     */
    function __construct($fileName=null, $adapter=Varien_Image_Adapter::ADAPTER_GD2)
    {
        //use custom adapter
        $this->_adapter = new Mirasvit_SeoSitemap_Model_ImageAdapter();
...
class Mirasvit_SeoSitemap_Model_Image extends Mage_Core_Model_Abstract
{
  ...
  //   	    $path[] = $this->getDestinationSubdir();
	...
	/**
	 * @return Mirasvit_SeoSitemap_Model_ImageVarien
	 */
	...
	public function getImageProcessor()
	{
		if (!$this->_processor) {
            try {
                $this->_processor = new Mirasvit_SeoSitemap_Model_ImageVarien($this->getBaseFile());
            } catch (Exception $e) {
                throw new Mirasvit_SeoSitemap_BadImageException();
            }
		}
